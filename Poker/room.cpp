...
room::room(QString _userId,int _roomlevel,int _roomnumber,QWidget *parent) :
    ...
    ui(new Ui::room)
{
    ...
    init();
    ourself = new player(userName,_userId);
    ourself->setmoney(userMoney);
...
void room::getbeforeplayer()
{
    ...
    {
        playerlist[i] = new player(othername[i],otherid[i]);
