...
public:
    ...
    void setupUi(QDialog *login)
    {
        ...
        Password->setGeometry(QRect(217, 88, 168, 40));
        ...
        Password->setStyleSheet(QStringLiteral("border-image: url(:/source/picture/background/singalroom.jpg);"));
        Password->setEchoMode(QLineEdit::Password);
        Password->setCursorPosition(0);
        userID = new QLineEdit(login);
        userID->setObjectName(QStringLiteral("userID"));
        userID->setGeometry(QRect(217, 40, 168, 40));
        QFont font1;
        ...
        userID->setStyleSheet(QStringLiteral("border-image: url(:/source/picture/background/singalroom.jpg);"));
